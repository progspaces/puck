...
def main(input = "data/images_copy", output_folder ="./output/timing_results/" , output_name ="hough_paper_programs", ground_truth_path = './data/annotations/annotations.json', cli_printout=True):
    ...
    for choice in tqdm(range(0,2,1)):
        pipeline(imageList, choice, times_dict,times_dict_sum,file_data )
    ...
    if cli_printout:
        print(f"This is a timing test run on {input}, for the arbitrary hough parameters and the paper programs method.\n\
