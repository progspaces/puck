...
def main(results_prefix =  "puck/output/program_recognition_results_", adjustment = "../", adjustment_on = True):
    cal_path ="puck/data/images_calibration/medium/"+ PAL+ "/jack_cole/medium_" + PAL + "_jack_cole_calibration.jpg"
    results_path = results_prefix + PAL + ".csv"
    if adjustment_on:
    ...
    a_paths =[path for path in p.glob("puck/data/images_copy/" + PAL + "/*/*/A/*_A*[0-4].jpg")]
    b_paths =[path for path in p.glob("puck/data/images_copy/" + PAL + "/*/*/B/*_B*[0-4].jpg")]
    c_paths =[path for path in p.glob("puck/data/images_copy/"+ PAL + "/*/*/C/*_C*[0-4].jpg")]
    d_paths =[path for path in p.glob("puck/data/images_copy/"+ PAL + "/*/*/D/*_D*[0-4].jpg")]
    print(a_paths)
